...
The framework is a globally-accessible knowledge base of adversary tactics and techniques. The following image shows the tactics and techniques covered by Würth IT Italy cyber security products.

In the matrix below, each cell represents a technique, while the columns represent the tactics. We tried to represent the coverage provided by Würth IT Italy services and platform in terms of techniques and tactics defined in the MITRE ATT&CK framework. You can find more information about the framework at `MITRE ATT&CK official website <https://attack.mitre.org/>`_.
